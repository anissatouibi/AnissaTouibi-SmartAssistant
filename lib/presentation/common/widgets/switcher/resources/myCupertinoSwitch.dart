...
import 'package:smart_assistant_app/presentation/common/widgets/switcher/resources/thumbPaint.dart';
...
class MyCupertinoSwitch extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.MyCupertinoSwitch.dragStartBehavior}
...
class _MyCupertinoSwitchState extends State<MyCupertinoSwitch> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      opacity: widget.onChanged == null ? _kMyCupertinoSwitchDisabledOpacity : 1.0,
      child: _MyCupertinoSwitchRenderObjectWidget(
        ...
        thumbColor:
            CupertinoDynamicColor.resolve(widget.thumbColor ?? CupertinoColors.white, context),
...
class _MyCupertinoSwitchRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderMyCupertinoSwitch renderObject) {
    renderObject
      ..value = value
      ..activeColor = activeColor
      ..trackColor = trackColor
...
// THUMB RADIUS IN thumbPaint.dart // ME NOTE
const double _kTrackWidth = 43.5;
const double _kTrackHeight = 26.5;
const double _kTrackRadius = 38.4;
...
const double _kMyCupertinoSwitchDisabledOpacity = 0.5;
...
class _RenderMyCupertinoSwitch extends RenderConstrainedBox {
  _RenderMyCupertinoSwitch({
    ...
    required _MyCupertinoSwitchState state,
        ...
        _thumbPainter = MyCupertinoThumbPainter.switchThumb(color: thumbColor),
  ...
  MyCupertinoThumbPainter _thumbPainter;
  set thumbColor(Color value) {
    if (value == thumbColor) return;
    _thumbPainter = MyCupertinoThumbPainter.switchThumb(color: value);
    markNeedsPaint();
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final RRect trackRRect =
        RRect.fromRectAndRadius(trackRect, const Radius.circular(_kTrackRadius));
    canvas.drawRRect(trackRRect, paint);

    final double currentThumbExtension = MyCupertinoThumbPainter.extension * currentReactionValue;
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - MyCupertinoThumbPainter.radius,
      trackRect.left + _kTrackInnerEnd - MyCupertinoThumbPainter.radius - currentThumbExtension,
      visualPosition,
    )!;
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + MyCupertinoThumbPainter.radius + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + MyCupertinoThumbPainter.radius,
      visualPosition,
    )!;
    final double thumbCenterY = offset.dy + size.height / 2.0;
    final Rect thumbBounds = Rect.fromLTRB(
      thumbLeft,
      thumbCenterY - MyCupertinoThumbPainter.radius,
      thumbRight,
      thumbCenterY + MyCupertinoThumbPainter.radius,
    );
