      ...
      builder: (context) {
        ...
        final confirmButton = Expanded(
          ...
          child: InkWell(
            ...
            child: Text(
              ...
              style: AppTextStyles.px14wRegular(context),
            ),
          ),
        ));
                ...
                child: CupertinoTheme(
                  data: CupertinoThemeData(
                    textTheme: CupertinoTextThemeData(
                        dateTimePickerTextStyle: AppTextStyles.px14wMedium(context)),
                  ),
                  child: FtsCupertinoDatePicker(
                    ...
                    onDateTimeChanged: (dateTime) {
                      if (widget.minTime != null && dateTime.isBefore(widget.minTime!)) {
                        _selectedDateTimeSpinner = widget.minTime!;
                      } else if (widget.maxTime != null && dateTime.isAfter(widget.maxTime!)) {
        ...
        Widget menuWithPositioned = AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            final opacityValue = _animation.value ?? 0;
            const value = 1.0;
            ...
            double right = screenWidth -
                (centerHorizontal + (((size.width) / 2 + _paddingHorizontal) * value));
            ...
            return Positioned(
              ...
              child: Opacity(
                ...
                child: ConstrainedBox(
                    ...
                    child: MainDiagonalCLipper(child: menu)),
              ),
            );
          },
        );
