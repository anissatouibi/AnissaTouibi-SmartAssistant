          ...
          FlutterError.reportError(
            FlutterErrorDetails(
              exception: FlutterError(
                ...
                'FtsCupertinoDatePicker because the parent is too narrow at '
                '${size.width}px.\n'
...
/// Different display modes of [FtsCupertinoDatePicker].
///
/// See also:
///
///  * [FtsCupertinoDatePicker], the class that implements different display modes
...
enum MyCupertinoDatePickerMode {
  ...
  /// The AM/PM designation is shown only if [FtsCupertinoDatePicker] does not use 24h format.
...
// Different types of column in FtsCupertinoDatePicker.
...
///
/// There are several modes of the date picker listed in [MyCupertinoDatePickerMode].
///
...
///
/// {@tool dartpad}
/// This sample shows how to implement FtsCupertinoDatePicker with different picker modes.
...
///
/// FtsCupertinoDatePicker can be displayed directly on a screen or in a popup.
///
...
class FtsCupertinoDatePicker extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [MyCupertinoDatePickerMode] and defaults
  /// to [MyCupertinoDatePickerMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes and must not be null. When in [MyCupertinoDatePickerMode.time] mode,
  /// the year, month and day will be the same as [initialDateTime]. When in
  /// [MyCupertinoDatePickerMode.date] mode, this callback will always report the
  /// start time of the currently selected day. When in
  /// [MyCupertinoDatePickerMode.monthYear] mode, the day and time will be the
  ...
  /// In [MyCupertinoDatePickerMode.time] mode, [minimumDate] should typically be
  ...
  /// In [MyCupertinoDatePickerMode.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [MyCupertinoDatePickerMode.date] mode. Defaults to 1 and must not be null.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [MyCupertinoDatePickerMode.date] mode. Null if there's no limit.
  ///
  ...
  ///
  /// [dateOrder] determines the order of the columns inside [FtsCupertinoDatePicker]
  /// in [MyCupertinoDatePickerMode.date] and [MyCupertinoDatePickerMode.monthYear]
  ...
  /// The mode of the date picker as one of [MyCupertinoDatePickerMode].
  /// Defaults to [MyCupertinoDatePickerMode.dateAndTime]. Cannot be null and
  ...
  ///
  /// In [MyCupertinoDatePickerMode.time] mode, a time becomes unselectable if the
  ...
  /// Determines the order of the columns inside [FtsCupertinoDatePicker] in
  /// [MyCupertinoDatePickerMode.date] and [MyCupertinoDatePickerMode.monthYear]
  /// mode. When using monthYear mode, both [DatePickerDateOrder.dmy] and
  /// [DatePickerDateOrder.mdy] will result in the month|year order.
  /// Defaults to the locale's default date format/order.
  ...
  State<StatefulWidget> createState() {
    ...
    switch (mode) {
      ...
      case CupertinoDatePickerMode.dateAndTime:
        return _MyCupertinoDatePickerDateTimeState();
      case CupertinoDatePickerMode.date:
        return _MyCupertinoDatePickerDateState(dateOrder: dateOrder);
...
class _MyCupertinoDatePickerDateTimeState extends State<FtsCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(FtsCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] = FtsCupertinoDatePicker._getColumnWidth(
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == MyCupertinoDatePickerMode.dateAndTime) {
...
class _MyCupertinoDatePickerDateState extends State<FtsCupertinoDatePicker> {
  _MyCupertinoDatePickerDateState({
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        FtsCupertinoDatePicker._getColumnWidth(
            _PickerColumnType.dayOfMonth, localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.month.index] = FtsCupertinoDatePicker._getColumnWidth(
        _PickerColumnType.month, localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.year.index] = FtsCupertinoDatePicker._getColumnWidth(
...
class _MyCupertinoDatePickerMonthYearState extends State<FtsCupertinoDatePicker> {
  _MyCupertinoDatePickerMonthYearState({
    required this.dateOrder,
  });
  final DatePickerDateOrder? dateOrder;
  late int textDirectionFactor;
