...
class ExpansionTileCard extends StatefulWidget {
  ...
  const ExpansionTileCard({
    ...
    this.persistChildrenState = true,
  }) : super(key: key);
  ...
  // whether children should go though initState on reOpen
  final bool persistChildrenState;
...
class ExpansionTileCardState extends State<ExpansionTileCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: widget.persistChildrenState
          ? IndexedStack(
              index: !closed ? 1 : 0,
              children: [
