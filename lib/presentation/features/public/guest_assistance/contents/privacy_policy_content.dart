    ...
    return MainScaffold(
      ...
      body: CustomScrollView(slivers: [
        const MainPopSliverAppBar(
          title: "context.t.drawer_items.privacy",
              ...
              return SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Column(children: [
                      for (PrivacyPolicy pp in state.data!.privacyPolicies)
                        ExpandableContentTileWidget(
                          title:
                              GeneralUtils.trField(context, textAr: pp.titleAr, textEn: pp.titleEn),
                          content: GeneralUtils.trField(context,
                              textAr: pp.contentAr, textEn: pp.contentEn),
                        ),
                    ]),
                  ));
            }
